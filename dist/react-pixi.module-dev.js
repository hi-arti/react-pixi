import { Texture, DisplayObject, Application, Container, Point, ObservablePoint, extras, Graphics, mesh, particles, Sprite, Text } from 'pixi.js';
...
var ReactFiberReconciler = Object.freeze({
	...
	deferredUpdates: scheduler$$1.unstable_next,
...
var scripts = {
	...
	prepublish: "if-env CI=true && echo \"skip build\" || (npm run build)"
};
var files = [
	"dist/",
	"LICENSE",
...
export { render, Stage, withPixiApp, PixiComponent, PixiFiber, AppProvider, AppConsumer, Context as AppContext, useTick, useApp, BitmapText$1 as BitmapText, Container$2 as Container, Graphics$2 as Graphics, NineSlicePlane$1 as NineSlicePlane, ParticleContainer$1 as ParticleContainer, Sprite$2 as Sprite, Text$2 as Text, TilingSprite$1 as TilingSprite, Mesh$1 as Mesh, Rope$1 as Rope };
